...
export const NEXT_STATUS: Record<AdminOrderStatus, AdminOrderStatus[]> = { pending: ["confirmed", "cancelled"], confirmed: ["shipped", "cancelled"], preparing: ["shipped", "cancelled"], shipped: ["delivered", "returned"], delivered: ["returned"], cancelled: ["pending"], returned: ["delivered"] };
