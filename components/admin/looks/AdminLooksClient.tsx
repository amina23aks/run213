...
const emptyDraft = { collectionId: "", collectionSlug: "", name: "", numberLabel: "", description: "", priceDzd: "", compareAtPriceDzd: "", heroImageUrl: "", heroImagePublicId: "", figureImageUrl: "", figureImagePublicId: "", productIds: [] as string[], status: "draft", sortOrder: "1", showAsHomepageFigure: false, homepageFigureOrder: "" };
...
export function AdminLooksClient() {
  ...
  async function save() {
    ...
    const body = JSON.stringify({ collectionId: draft.collectionId, collectionSlug, slug: slugPreview, name: draft.name, numberLabel: draft.numberLabel, description: draft.description, priceDzd: draft.priceDzd, compareAtPriceDzd: draft.compareAtPriceDzd || null, heroImage: { url: draft.heroImageUrl, alt: draft.name, publicId: draft.heroImagePublicId || undefined }, figureImage: draft.figureImageUrl ? { url: draft.figureImageUrl, alt: draft.name, publicId: draft.figureImagePublicId || undefined } : null, productIds: draft.productIds, status: draft.status, sortOrder: toInteger(draft.sortOrder) ?? 1, showAsHomepageFigure: draft.showAsHomepageFigure, homepageFigureOrder: validation.homepageFigureOrder });
