...
const emptyDraft = { collectionId: "", collectionSlug: "", name: "", numberLabel: "", description: "", heroImageUrl: "", heroImagePublicId: "", figureImageUrl: "", figureImagePublicId: "", productIds: [] as string[], status: "draft", sortOrder: "1", showAsHomepageFigure: false, homepageFigureOrder: "" };
