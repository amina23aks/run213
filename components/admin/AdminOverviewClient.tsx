...
const secondaryCards: CardDefinition[] = [
  { key: "returnCostsDzd", label: "RETURN COSTS", href: "/admin/orders", icon: RotateCcw, tone: "returned", money: true, compare: true, detail: "Return events recorded in this Algeria-time period" },
